...
export default class App extends React.Component{
    ...
    render() {
        ...
        <section className="todoapp">
            ...
            <TaskList taskList={visibility} onDelete={this.deleteTask} doneItem={this.doneItem}
                      onDone={this.onDone} date={this.date}/>
            <Footer doneCounter={doneCounter} taskList={this.state.taskList} filter={this.filter} filtration={this.filtration}
